...
@Data
public class ReqTaskChildCreate {
	...
	@ValidStringMedium(message = "title không được chứa các ký tự đặc biệt")
	public String title;
	...
	/**
	 * Nhiệm vụ cần xem xét duyệt hoàn thành
	 */
	...
	/**
	 * Nếu không yêu cầu xác nhận thì mới được phép chọn thay mặt báo cáo
	 */
	public boolean allowDelegate=false;
