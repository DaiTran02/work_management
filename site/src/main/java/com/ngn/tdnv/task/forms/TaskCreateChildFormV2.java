...
import com.ngn.tdnv.doc.forms.create_task.TaskChooseFollowerByOrgForm;
...
public class TaskCreateChildFormV2 extends VerticalLayoutTemplate implements FormInterface{
	...
	public TaskCreateChildFormV2(String idDoc,BelongOrganizationModel belongOrganizationModel,UserAuthenticationModel userAuthenticationModel,SignInOrgModel signInOrgModel,String idTask) {
...
//			Span spanWarningOwner = new Span("Văn bản này ");
//
...
//			contentInFoDoc.add(spanWarningOwner);
	...
	private void createLayoutFormTask() {
		...
		vLayout3.add(hLayoutOwner,hLayoutFollowUp,hLayoutAssistant,hLayoutAssignee,hLayoutSupport);
		...
		content.add(hLayout1,txtDescr,hLayout2,vLayout3,cbRequiredConfirm,titleAttach,upload,btnAssigned);
		upload.initUpload();
