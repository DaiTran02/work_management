...
public class DocListLazyLoadForm extends VerticalLayoutTemplate implements FormInterface{
	private static final long serialVersionUID = 1L;
	private Logger log = LogManager.getLogger(DocListForm.class);
	private boolean isMobileLayout = false;

	private VirtualList<DocModel> lazyLoad = new VirtualList<DocModel>();
	...
	public DocListLazyLoadForm(UserAuthenticationModel userAuthenticationModel,BelongOrganizationModel belongOrganizationModel,SignInOrgModel signInOrgModel,boolean checkAddDoc,
	...
	public void buildLayout() {
		...
		lazyLoad.getStyle().setPadding("10px");
		
		this.add(filterDocForm,paginationForm,lazyLoad);
	}
	...
	public void loadData() {
		...
		lazyLoad.setItems(listModel);
		lazyLoad.setRenderer(itemRender);
	...
	private ComponentRenderer<Component, DocModel> itemRender = new ComponentRenderer<Component, DocModel>(docModel->{
		...
		vLayoutItemDoc.getStyle().setBoxShadow("rgba(0, 0, 0, 0.16) 0px 1px 4px").setPadding("10px").setBorderRadius("10px").setMargin("10px 0");
