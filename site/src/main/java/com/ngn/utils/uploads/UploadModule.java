...
public class UploadModule extends VerticalLayout implements FormInterface{
	...
	protected Integer maxFileSize = 10 * 1024 * 1024;;
	...
	public void buildLayout() {
		...
		upload.setAcceptedFileTypes(PropsUtil.getListTypeFile());
