...
@Data
public class ApiListTaskFollowerModel {
	private String id;
	...
	public String getStartTimeText() {
		return startingTime == 0 ? "Chưa bắt đầu" : LocalDateUtil.dfDate.format(this.getStartingTime());
	}
	...
	public String getOwnerText() {
		String userOwner = owner.getOrganizationUserName() == null ? "" : " (" +owner.getOrganizationUserName()+")";
		return owner.getOrganizationName()+userOwner;
	}
	
	public String getAssistantText() {
		String userAssistant = assistant.getOrganizationUserName() == null ? "" : " ("+assistant.getOrganizationUserName()+")";
		return assistant.getOrganizationName()+userAssistant;
	}
