...
@Data
public class ApiListTasksOwnerModel {
	private String id;
	...
	public String getStartTimeText() {
		return this.startingTime == 0 ? "Chưa bắt đầu" : LocalDateUtil.dfDate.format(this.getStartingTime());
	}
	...
	public String getFollowerText() {
		return followers.isEmpty() ? "Không có" : followers.get(0).getOrganizationName();
	}
	
	public String getAssigneeText() {
		return assignee.getOrganizationUserId() != null ? assignee.getOrganizationName()+"("+assignee.getOrganizationUserName()+")" : assignee.getOrganizationName();
	}
